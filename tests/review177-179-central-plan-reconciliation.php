...
if (is_string($central)) {
    ...
    $check(str_contains($central, "'design_token_owner' => 'file-25'"), 'Review 178: contract must declare File 25 as canonical design-token owner.');
    $check(str_contains($central, "'structural_layout_owner' => 'file-20'"), 'Review 178: File 20 structural shell ownership must remain explicit.');
